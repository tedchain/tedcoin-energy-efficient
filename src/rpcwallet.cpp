...
//    obj.push_back(Pair("PoW difficulty",    (double)GetDifficulty()));
	...
	obj.push_back(Pair("updates",    "http://tedchain.network"));
    return obj;
}
...
// Tedcoin: resend unconfirmed wallet transactions
