...
void OptionsModel::Init()
{
    ...
    fUseTedcoinTheme = settings.value("fUseTedcoinTheme", true).toBool();
...
QVariant OptionsModel::data(const QModelIndex & index, int role) const
{
    if(role == Qt::EditRole)
    {
        ...
        case UseTedcoinTheme:
            return QVariant(fUseTedcoinTheme);
        case ShowIrcButton:
...
bool OptionsModel::setData(const QModelIndex & index, const QVariant & value, int role)
{
    ...
    if(role == Qt::EditRole)
    {
        ...
        case CoinControlFeatures: {
          ...
          case UseTedcoinTheme:
            fUseTedcoinTheme = value.toBool();
            settings.setValue("fUseTedcoinTheme", fUseTedcoinTheme);
            break;
	case ShowIrcButton: {
